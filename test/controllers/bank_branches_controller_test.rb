...
class BankBranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_branch" do
    assert_difference('BankBranch.count') do
      post bank_branches_url, params: { bank_branch: { address: @bank_branch.address, ifsc_code: @bank_branch.ifsc_code, manager_id: @bank_branch.manager_id, micr_code: @bank_branch.micr_code, name: @bank_branch.name } }
    end
  ...
  test "should update bank_branch" do
    patch bank_branch_url(@bank_branch), params: { bank_branch: { address: @bank_branch.address, ifsc_code: @bank_branch.ifsc_code, manager_id: @bank_branch.manager_id, micr_code: @bank_branch.micr_code, name: @bank_branch.name } }
